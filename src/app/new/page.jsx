  ...
  return (
    <div>
        ...
        <div className='py-10 w-full h-screen'>
            <Image src={'/4.png'} width={400} height={400} alt='' className='rounded-b-full absolute top-0 left-0 ml-[10%]'/>
            <div className='flex flex-col md:flex-row'>
                <div className='w-[40%] place-content-end'>
                
                </div>
                <div className='w-[60%] py-6 flex items-center flex-col '>
        ...
        <div className='h-screen w-full py-6'>
            <h2 className="text-3xl font-bold text-black text-center">Our Philosophy</h2>
            <div className='flex items-center gap-4 px-8 pt-20'>
        ...
        <div className='h-screen w-full'>
          <div className='flex flex-col md:flex-row items-start'>
            <div className='w-full md:w-1/3 pl-10 '>
                 <h2 className='text-secondary text-3xl font-bold'>What You Get</h2>
            ...
            <div className='w-full md:w-2/3 px-5 '>
              ...
              <div className='flex flex-col gap-3 px-3 pt-6 '>
                <div className='flex flex-col gap-2'>
                    <div>
                    <p className="bg-secondary text-white p-1 rounded-2xl w-[30%] text-center">
